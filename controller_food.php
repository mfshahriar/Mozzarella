                ...
                ?>
                    <div class="row m-3" style="height: 100px; background-color:white;">
                        <div class="col-sm-5" style="background-color:white;">
                            <h3 class="text-center"><?php echo $item["f_name"] ?></h3>
                            <h4 class="text-center">Price Now: <i id="price_<?php echo $item["id"] ?>"><?php echo $item["price"] ?></i>TK</h4>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <button onclick='sendData("<?php echo $item["id"] ?>")' type="submit" class="add_btn btn btn-info mt-0" style="font-size:large; height: 100px; width: 130px; background-color:#e67300;">Change Price</button>
                        </div>
                    </div>
                ...
                <div class="row" style="height: 75px; background-color:white; margin-top: 25px;">
                    <div class="col-sm-12" style="background-color:white;">
                        <table class="table table-borderedless" style="border: solid; width:100%;">
                            <tr>
                                <td colspan="2">
                                    <label for="name ">Item Name:</label><input id="inp_name" name="name" type="text" style="width: 100%;">
                                </td>
                                <td rowspan="2">
                                    <button onclick="addNewItem()" type="button" class=" btn btn-info p-5 mt-3" style="width:100%; height:100%">ADD ITEM</button>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="price">Price:</label><input id="inp_price" name="price" type="text" style="width: 100%;">
                                </td>
                                <td><label for="type">Type:</label><input id="inp_type" name="type" type="text" style="width: 100%;"></td>
                            </tr>
...
<div class="footer text-muted">
    <div id="hidden_div">
        <form action="controller_food.php" method="POST" enctype="multipart/form-data">
    ...
    <script src="JS/controller_food.js"></script>
</div>
