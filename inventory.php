        ...
        <div class="row" style="height: 75px; background-color:white; margin-top: 25px;">
          <div class="col-sm-12" style="background-color:white;">
            <table class="table table-borderedless" style="border: solid; width:100%;">
              <tr>
                <td colspan="2">
                  <label for="name ">Ingridient Name:</label><input name="name" type="text" style="width: 100%;">
                </td>
                <td rowspan="2">
                  <button type="button" class=" btn btn-info p-5 mt-3" style="width:100%; height:100%">ADD INGRIDENT</button>
                </td>
              </tr>
              <tr>
                <td>
                  <label for="amount">Amount:</label><input name="amount" type="text" style="width: 100%;">
                </td>
                <td><label for="per_cost">Per(KG) Cost:</label><input name="per_cost" type="text" style="width: 100%;"></td>
              </tr>
            </table>
